            ...
            <div class="card card-custom p-4 p-sm-5 rounded-4 shadow-sm">
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        <!-- Nombre completo -->
                        <div class="mb-3">
                            <asp:Label ID="lblNombreCompleto" runat="server" AssociatedControlID="txtNombreCompleto" Text="Nombre Completo" CssClass="form-label fw-medium" />
                            ...
                            <asp:RequiredFieldValidator ID="valNombreCompleto" runat="server"
                        ...
                        <asp:Label ID="lblSuccess" runat="server" CssClass="text-success text-center mb-3" EnableViewState="false" />
