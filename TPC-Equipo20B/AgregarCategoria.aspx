...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <!-- 🟢 Encabezado -->
    <div class="mb-8">
        <h2 class="text-3xl font-bold text-slate-900 dark:text-white">Agregar Nueva Categoría</h2>
        <p class="text-sm text-primary mt-1">Ingrese el nombre de la categoría</p>
    </div>
